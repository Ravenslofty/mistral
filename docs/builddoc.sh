...
for b in cbuf cmuxp cmuxcr cmuxhg cmuxhr cmuxvg cmuxvr ctrl dll dqs16 fpll gpio hip hmc hps_clocks hssi lvl term hps_clocks_resets hps_jtag hps_peripheral_emac hps_peripheral_spi_master hps_peripheral_qspi hps_tpiu_trace; do
