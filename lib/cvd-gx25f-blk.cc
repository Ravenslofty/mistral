...
const mistral::CycloneV::p2r_info mistral::CycloneV::gx25f_p2r_info[] = {
  ...
  { pnode(CMUXVG, 25, 0, SWITCHIN, 0, 1), rnode(GOUT, 24, 0, 2) },
  { pnode(CMUXVG, 25, 0, SWITCHIN, 1, 1), rnode(GOUT, 24, 0, 1) },
  { pnode(CMUXVG, 25, 0, SWITCHIN, 0, 2), rnode(GOUT, 22, 0, 35) },
  { pnode(CMUXVG, 25, 0, SWITCHIN, 1, 2), rnode(GOUT, 22, 0, 36) },
  { pnode(CMUXVG, 25, 0, SWITCHIN, 0, 3), rnode(GOUT, 24, 0, 6) },
  { pnode(CMUXVG, 25, 0, SWITCHIN, 1, 3), rnode(GOUT, 24, 0, 7) },
  ...
  { pnode(CMUXVG, 26, 39, SWITCHIN, 0, 1), rnode(GOUT, 24, 39, 2) },
  { pnode(CMUXVG, 26, 39, SWITCHIN, 1, 1), rnode(GOUT, 24, 39, 1) },
  { pnode(CMUXVG, 26, 39, SWITCHIN, 0, 2), rnode(GOUT, 22, 39, 35) },
  { pnode(CMUXVG, 26, 39, SWITCHIN, 1, 2), rnode(GOUT, 22, 39, 36) },
  { pnode(CMUXVG, 26, 39, SWITCHIN, 0, 3), rnode(GOUT, 24, 39, 6) },
  { pnode(CMUXVG, 26, 39, SWITCHIN, 1, 3), rnode(GOUT, 24, 39, 7) },
  ...
  { pnode(CMUXHG, 48, 9, SWITCHIN, 0, 1), rnode(GOUT, 48, 9, 70) },
  { pnode(CMUXHG, 48, 9, SWITCHIN, 1, 1), rnode(GOUT, 48, 9, 71) },
  { pnode(CMUXHG, 48, 9, SWITCHIN, 0, 2), rnode(GOUT, 48, 8, 1) },
  { pnode(CMUXHG, 48, 9, SWITCHIN, 1, 2), rnode(GOUT, 48, 8, 2) },
  { pnode(CMUXHG, 48, 9, SWITCHIN, 0, 3), rnode(GOUT, 48, 8, 7) },
  { pnode(CMUXHG, 48, 9, SWITCHIN, 1, 3), rnode(GOUT, 48, 8, 6) },
...
const mistral::CycloneV::p2p_info mistral::CycloneV::gx25f_p2p_info[] = {
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 0), pnode(GPIO, 25, 39, DATAOUT, 1, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 1), pnode(GPIO, 25, 39, DATAOUT, 1, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 2), pnode(GPIO, 25, 39, DATAOUT, 1, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 3), pnode(GPIO, 25, 39, DATAOUT, 1, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 4), pnode(GPIO, 25, 39, DATAOUT, 0, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 5), pnode(GPIO, 25, 39, DATAOUT, 0, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 6), pnode(GPIO, 25, 39, DATAOUT, 0, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 7), pnode(GPIO, 25, 39, DATAOUT, 0, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 8), pnode(GPIO, 25, 39, DATAOUT, 2, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 9), pnode(GPIO, 25, 39, DATAOUT, 2, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 10), pnode(GPIO, 25, 39, DATAOUT, 2, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 11), pnode(GPIO, 25, 39, DATAOUT, 2, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 12), pnode(GPIO, 27, 39, DATAOUT, 3, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 13), pnode(GPIO, 27, 39, DATAOUT, 3, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 14), pnode(GPIO, 27, 39, DATAOUT, 3, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 15), pnode(GPIO, 27, 39, DATAOUT, 3, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 16), pnode(GPIO, 29, 39, DATAOUT, 1, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 17), pnode(GPIO, 29, 39, DATAOUT, 1, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 18), pnode(GPIO, 29, 39, DATAOUT, 1, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 19), pnode(GPIO, 29, 39, DATAOUT, 1, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 20), pnode(GPIO, 29, 39, DATAOUT, 0, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 21), pnode(GPIO, 29, 39, DATAOUT, 0, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 22), pnode(GPIO, 29, 39, DATAOUT, 0, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 23), pnode(GPIO, 29, 39, DATAOUT, 0, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 24), pnode(GPIO, 29, 39, DATAOUT, 2, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 25), pnode(GPIO, 29, 39, DATAOUT, 2, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 26), pnode(GPIO, 29, 39, DATAOUT, 2, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 27), pnode(GPIO, 29, 39, DATAOUT, 2, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 28), pnode(GPIO, 31, 39, DATAOUT, 3, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 29), pnode(GPIO, 31, 39, DATAOUT, 3, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 30), pnode(GPIO, 31, 39, DATAOUT, 3, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 31), pnode(GPIO, 31, 39, DATAOUT, 3, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 36), pnode(GPIO, 33, 39, DATAOUT, 1, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 37), pnode(GPIO, 33, 39, DATAOUT, 1, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 38), pnode(GPIO, 33, 39, DATAOUT, 1, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 39), pnode(GPIO, 33, 39, DATAOUT, 1, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 40), pnode(GPIO, 33, 39, DATAOUT, 0, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 41), pnode(GPIO, 33, 39, DATAOUT, 0, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 42), pnode(GPIO, 33, 39, DATAOUT, 0, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 43), pnode(GPIO, 33, 39, DATAOUT, 0, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 44), pnode(GPIO, 33, 39, DATAOUT, 2, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 45), pnode(GPIO, 33, 39, DATAOUT, 2, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 46), pnode(GPIO, 33, 39, DATAOUT, 2, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 47), pnode(GPIO, 33, 39, DATAOUT, 2, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 48), pnode(GPIO, 35, 39, DATAOUT, 3, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 49), pnode(GPIO, 35, 39, DATAOUT, 3, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 50), pnode(GPIO, 35, 39, DATAOUT, 3, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 51), pnode(GPIO, 35, 39, DATAOUT, 3, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 52), pnode(GPIO, 37, 39, DATAOUT, 1, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 53), pnode(GPIO, 37, 39, DATAOUT, 1, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 54), pnode(GPIO, 37, 39, DATAOUT, 1, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 55), pnode(GPIO, 37, 39, DATAOUT, 1, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 56), pnode(GPIO, 37, 39, DATAOUT, 0, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 57), pnode(GPIO, 37, 39, DATAOUT, 0, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 58), pnode(GPIO, 37, 39, DATAOUT, 0, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 59), pnode(GPIO, 37, 39, DATAOUT, 0, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 60), pnode(GPIO, 37, 39, DATAOUT, 2, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 61), pnode(GPIO, 37, 39, DATAOUT, 2, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 62), pnode(GPIO, 37, 39, DATAOUT, 2, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 63), pnode(GPIO, 37, 39, DATAOUT, 2, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 64), pnode(GPIO, 39, 39, DATAOUT, 3, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 65), pnode(GPIO, 39, 39, DATAOUT, 3, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 66), pnode(GPIO, 39, 39, DATAOUT, 3, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 67), pnode(GPIO, 39, 39, DATAOUT, 3, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 72), pnode(GPIO, 41, 39, DATAOUT, 1, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 73), pnode(GPIO, 41, 39, DATAOUT, 1, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 74), pnode(GPIO, 41, 39, DATAOUT, 1, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 75), pnode(GPIO, 41, 39, DATAOUT, 1, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 76), pnode(GPIO, 41, 39, DATAOUT, 0, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 77), pnode(GPIO, 41, 39, DATAOUT, 0, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 78), pnode(GPIO, 41, 39, DATAOUT, 0, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 79), pnode(GPIO, 41, 39, DATAOUT, 0, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 80), pnode(GPIO, 41, 39, DATAOUT, 2, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 81), pnode(GPIO, 41, 39, DATAOUT, 2, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 82), pnode(GPIO, 41, 39, DATAOUT, 2, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 83), pnode(GPIO, 41, 39, DATAOUT, 2, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 84), pnode(GPIO, 42, 39, DATAOUT, 3, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 85), pnode(GPIO, 42, 39, DATAOUT, 3, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 86), pnode(GPIO, 42, 39, DATAOUT, 3, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 87), pnode(GPIO, 42, 39, DATAOUT, 3, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 88), pnode(GPIO, 43, 39, DATAOUT, 1, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 89), pnode(GPIO, 43, 39, DATAOUT, 1, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 90), pnode(GPIO, 43, 39, DATAOUT, 1, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 91), pnode(GPIO, 43, 39, DATAOUT, 1, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 92), pnode(GPIO, 43, 39, DATAOUT, 0, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 93), pnode(GPIO, 43, 39, DATAOUT, 0, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 94), pnode(GPIO, 43, 39, DATAOUT, 0, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 95), pnode(GPIO, 43, 39, DATAOUT, 0, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 96), pnode(GPIO, 43, 39, DATAOUT, 2, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 97), pnode(GPIO, 43, 39, DATAOUT, 2, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 98), pnode(GPIO, 43, 39, DATAOUT, 2, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 99), pnode(GPIO, 43, 39, DATAOUT, 2, 3) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 100), pnode(GPIO, 45, 39, DATAOUT, 3, 0) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 101), pnode(GPIO, 45, 39, DATAOUT, 3, 1) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 102), pnode(GPIO, 45, 39, DATAOUT, 3, 2) },
  { pnode(HMC, 15, 39, DDIOPHYDQDIN, -1, 103), pnode(GPIO, 45, 39, DATAOUT, 3, 3) },
  ...
  { pnode(HMC, 15, 39, PNONE, -1, -1), pnode(LEVELING_DELAY_CHAIN, 32, 39, PNONE, -1, -1) },
  { pnode(CMUXHG, 0, 8, CLKPIN, -1, 0), pnode(GPIO, 8, 39, COMBOUT, 0, -1) },
  { pnode(CMUXHR, 0, 8, CLKPIN, -1, 0), pnode(GPIO, 8, 39, COMBOUT, 0, -1) },
  { pnode(CMUXHG, 0, 8, CLKPIN, -1, 1), pnode(GPIO, 16, 0, COMBOUT, 0, -1) },
  { pnode(CMUXHR, 0, 8, CLKPIN, -1, 1), pnode(GPIO, 16, 0, COMBOUT, 0, -1) },
  { pnode(CMUXHG, 0, 8, CLKPIN, -1, 2), pnode(GPIO, 16, 39, COMBOUT, 0, -1) },
  { pnode(CMUXHR, 0, 8, CLKPIN, -1, 2), pnode(GPIO, 16, 39, COMBOUT, 0, -1) },
  { pnode(CMUXHG, 0, 8, CLKPIN, -1, 3), pnode(GPIO, 21, 0, COMBOUT, 0, -1) },
  { pnode(CMUXHR, 0, 8, CLKPIN, -1, 3), pnode(GPIO, 21, 0, COMBOUT, 0, -1) },
  { pnode(CMUXHG, 0, 8, CLKPIN, -1, 4), pnode(GPIO, 31, 39, COMBOUT, 0, -1) },
  { pnode(CMUXHR, 0, 8, CLKPIN, -1, 4), pnode(GPIO, 31, 39, COMBOUT, 0, -1) },
  { pnode(CMUXHG, 0, 8, CLKPIN, -1, 5), pnode(GPIO, 32, 0, COMBOUT, 0, -1) },
  { pnode(CMUXHR, 0, 8, CLKPIN, -1, 5), pnode(GPIO, 32, 0, COMBOUT, 0, -1) },
  { pnode(CMUXHG, 0, 8, CLKPIN, -1, 6), pnode(GPIO, 39, 39, COMBOUT, 0, -1) },
  { pnode(CMUXHR, 0, 8, CLKPIN, -1, 6), pnode(GPIO, 39, 39, COMBOUT, 0, -1) },
  { pnode(CMUXHG, 0, 8, CLKPIN, -1, 7), pnode(GPIO, 39, 0, COMBOUT, 0, -1) },
  { pnode(CMUXHR, 0, 8, CLKPIN, -1, 7), pnode(GPIO, 39, 0, COMBOUT, 0, -1) },
  { pnode(CMUXHG, 0, 8, NCLKPIN, -1, 0), pnode(GPIO, 8, 39, COMBOUT, 1, -1) },
  { pnode(CMUXHR, 0, 8, NCLKPIN, -1, 0), pnode(GPIO, 8, 39, COMBOUT, 1, -1) },
  { pnode(CMUXHG, 0, 8, NCLKPIN, -1, 1), pnode(GPIO, 16, 0, COMBOUT, 1, -1) },
  { pnode(CMUXHR, 0, 8, NCLKPIN, -1, 1), pnode(GPIO, 16, 0, COMBOUT, 1, -1) },
  { pnode(CMUXHG, 0, 8, NCLKPIN, -1, 2), pnode(GPIO, 16, 39, COMBOUT, 1, -1) },
  { pnode(CMUXHR, 0, 8, NCLKPIN, -1, 2), pnode(GPIO, 16, 39, COMBOUT, 1, -1) },
  { pnode(CMUXHG, 0, 8, NCLKPIN, -1, 3), pnode(GPIO, 21, 0, COMBOUT, 1, -1) },
  { pnode(CMUXHR, 0, 8, NCLKPIN, -1, 3), pnode(GPIO, 21, 0, COMBOUT, 1, -1) },
  { pnode(CMUXHG, 0, 8, NCLKPIN, -1, 4), pnode(GPIO, 31, 39, COMBOUT, 1, -1) },
  { pnode(CMUXHR, 0, 8, NCLKPIN, -1, 4), pnode(GPIO, 31, 39, COMBOUT, 1, -1) },
  { pnode(CMUXHG, 0, 8, NCLKPIN, -1, 5), pnode(GPIO, 32, 0, COMBOUT, 1, -1) },
  { pnode(CMUXHR, 0, 8, NCLKPIN, -1, 5), pnode(GPIO, 32, 0, COMBOUT, 1, -1) },
  { pnode(CMUXHG, 0, 8, NCLKPIN, -1, 6), pnode(GPIO, 39, 39, COMBOUT, 1, -1) },
  { pnode(CMUXHR, 0, 8, NCLKPIN, -1, 6), pnode(GPIO, 39, 39, COMBOUT, 1, -1) },
  { pnode(CMUXHG, 0, 8, NCLKPIN, -1, 7), pnode(GPIO, 39, 0, COMBOUT, 1, -1) },
  { pnode(CMUXHR, 0, 8, NCLKPIN, -1, 7), pnode(GPIO, 39, 0, COMBOUT, 1, -1) },
  ...
  { pnode(CMUXHR, 0, 8, PLLIN, -1, 0), pnode(FPLL, 0, 31, CLKOUT, -1, 4) },
  { pnode(CMUXHR, 0, 8, PLLIN, -1, 1), pnode(FPLL, 0, 13, CLKOUT, -1, 7) },
  { pnode(CMUXHR, 0, 8, PLLIN, -1, 2), pnode(FPLL, 0, 31, CLKOUT, -1, 4) },
  { pnode(CMUXHR, 0, 8, PLLIN, -1, 3), pnode(FPLL, 0, 13, CLKOUT, -1, 5) },
  { pnode(CMUXHR, 0, 8, PLLIN, -1, 4), pnode(FPLL, 0, 13, CLKOUT, -1, 4) },
  { pnode(CMUXCR, 0, 37, CLKPIN, -1, 0), pnode(GPIO, 8, 39, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 0, 37, CLKPIN, -1, 1), pnode(GPIO, 16, 39, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 0, 37, CLKPIN, -1, 2), pnode(GPIO, 31, 39, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 0, 37, CLKPIN, -1, 3), pnode(GPIO, 39, 39, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 0, 37, NCLKPIN, -1, 0), pnode(GPIO, 8, 39, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 0, 37, NCLKPIN, -1, 1), pnode(GPIO, 16, 39, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 0, 37, NCLKPIN, -1, 2), pnode(GPIO, 31, 39, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 0, 37, NCLKPIN, -1, 3), pnode(GPIO, 39, 39, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 0, 37, PLLIN, -1, 0), pnode(FPLL, 0, 31, CLKOUT, -1, 2) },
  { pnode(CMUXCR, 0, 37, PLLIN, -1, 1), pnode(FPLL, 0, 31, CLKOUT, -1, 6) },
  { pnode(CMUXCR, 0, 37, PLLIN, -1, 2), pnode(FPLL, 0, 31, CLKOUT, -1, 0) },
  { pnode(CMUXCR, 0, 37, PLLIN, -1, 3), pnode(FPLL, 0, 31, CLKOUT, -1, 4) },
  { pnode(CMUXCR, 0, 37, PLLIN, -1, 8), pnode(FPLL, 0, 31, CLKOUT, -1, 0) },
  { pnode(CMUXCR, 0, 37, PLLIN, -1, 9), pnode(FPLL, 0, 31, CLKOUT, -1, 3) },
  { pnode(CMUXCR, 0, 37, PLLIN, -1, 10), pnode(FPLL, 0, 31, CLKOUT, -1, 5) },
  { pnode(CMUXCR, 0, 37, PLLIN, -1, 11), pnode(FPLL, 0, 31, CLKOUT, -1, 1) },
  { pnode(CMUXCR, 0, 37, PLLIN, -1, 16), pnode(FPLL, 0, 31, CLKOUT, -1, 7) },
  { pnode(CMUXCR, 0, 37, PLLIN, -1, 17), pnode(FPLL, 0, 31, CLKOUT, -1, 8) },
  { pnode(CMUXCR, 3, 0, CLKPIN, -1, 0), pnode(GPIO, 16, 0, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 3, 0, CLKPIN, -1, 1), pnode(GPIO, 21, 0, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 3, 0, CLKPIN, -1, 2), pnode(GPIO, 32, 0, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 3, 0, CLKPIN, -1, 3), pnode(GPIO, 39, 0, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 3, 0, NCLKPIN, -1, 0), pnode(GPIO, 16, 0, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 3, 0, NCLKPIN, -1, 1), pnode(GPIO, 21, 0, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 3, 0, NCLKPIN, -1, 2), pnode(GPIO, 32, 0, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 3, 0, NCLKPIN, -1, 3), pnode(GPIO, 39, 0, COMBOUT, 1, -1) },
  { pnode(CMUXVG, 25, 0, CLKPIN, -1, 0), pnode(GPIO, 16, 0, COMBOUT, 0, -1) },
  { pnode(CMUXVR, 25, 0, CLKPIN, -1, 0), pnode(GPIO, 16, 0, COMBOUT, 0, -1) },
  { pnode(CMUXVG, 25, 0, CLKPIN, -1, 1), pnode(GPIO, 32, 0, COMBOUT, 0, -1) },
  { pnode(CMUXVR, 25, 0, CLKPIN, -1, 1), pnode(GPIO, 32, 0, COMBOUT, 0, -1) },
  { pnode(CMUXVG, 25, 0, CLKPIN, -1, 2), pnode(GPIO, 21, 0, COMBOUT, 0, -1) },
  { pnode(CMUXVR, 25, 0, CLKPIN, -1, 2), pnode(GPIO, 21, 0, COMBOUT, 0, -1) },
  { pnode(CMUXVG, 25, 0, CLKPIN, -1, 3), pnode(GPIO, 39, 0, COMBOUT, 0, -1) },
  { pnode(CMUXVR, 25, 0, CLKPIN, -1, 3), pnode(GPIO, 39, 0, COMBOUT, 0, -1) },
  { pnode(CMUXVG, 25, 0, NCLKPIN, -1, 0), pnode(GPIO, 16, 0, COMBOUT, 1, -1) },
  { pnode(CMUXVR, 25, 0, NCLKPIN, -1, 0), pnode(GPIO, 16, 0, COMBOUT, 1, -1) },
  { pnode(CMUXVG, 25, 0, NCLKPIN, -1, 1), pnode(GPIO, 32, 0, COMBOUT, 1, -1) },
  { pnode(CMUXVR, 25, 0, NCLKPIN, -1, 1), pnode(GPIO, 32, 0, COMBOUT, 1, -1) },
  { pnode(CMUXVG, 25, 0, NCLKPIN, -1, 2), pnode(GPIO, 21, 0, COMBOUT, 1, -1) },
  { pnode(CMUXVR, 25, 0, NCLKPIN, -1, 2), pnode(GPIO, 21, 0, COMBOUT, 1, -1) },
  { pnode(CMUXVG, 25, 0, NCLKPIN, -1, 3), pnode(GPIO, 39, 0, COMBOUT, 1, -1) },
  { pnode(CMUXVR, 25, 0, NCLKPIN, -1, 3), pnode(GPIO, 39, 0, COMBOUT, 1, -1) },
  { pnode(CMUXVG, 25, 0, PLLIN, -1, 0), pnode(FPLL, 48, 0, CLKOUT, -1, 8) },
  { pnode(CMUXVG, 25, 0, PLLIN, -1, 4), pnode(FPLL, 48, 0, CLKOUT, -1, 8) },
  { pnode(CMUXVG, 25, 0, PLLIN, -1, 5), pnode(FPLL, 48, 0, CLKOUT, -1, 7) },
  { pnode(CMUXVG, 25, 0, PLLIN, -1, 6), pnode(FPLL, 48, 0, CLKOUT, -1, 6) },
  { pnode(CMUXVG, 25, 0, PLLIN, -1, 7), pnode(FPLL, 48, 0, CLKOUT, -1, 5) },
  { pnode(CMUXVR, 25, 0, PLLIN, -1, 0), pnode(FPLL, 48, 0, CLKOUT, -1, 8) },
  { pnode(CMUXVR, 25, 0, PLLIN, -1, 1), pnode(FPLL, 48, 0, CLKOUT, -1, 7) },
  { pnode(CMUXVR, 25, 0, PLLIN, -1, 2), pnode(FPLL, 48, 0, CLKOUT, -1, 6) },
  { pnode(CMUXVR, 25, 0, PLLIN, -1, 3), pnode(FPLL, 48, 0, CLKOUT, -1, 5) },
  { pnode(CMUXVR, 25, 0, PLLIN, -1, 4), pnode(FPLL, 48, 0, CLKOUT, -1, 4) },
  { pnode(CMUXVR, 25, 0, PLLIN, -1, 5), pnode(FPLL, 48, 0, CLKOUT, -1, 3) },
  { pnode(CMUXVR, 25, 0, PLLIN, -1, 6), pnode(FPLL, 48, 0, CLKOUT, -1, 2) },
  { pnode(CMUXVR, 25, 0, PLLIN, -1, 7), pnode(FPLL, 48, 0, CLKOUT, -1, 1) },
  { pnode(CMUXVR, 25, 0, PLLIN, -1, 8), pnode(FPLL, 48, 0, CLKOUT, -1, 0) },
  { pnode(CMUXVG, 26, 39, CLKPIN, -1, 0), pnode(GPIO, 8, 39, COMBOUT, 0, -1) },
  { pnode(CMUXVR, 26, 39, CLKPIN, -1, 0), pnode(GPIO, 8, 39, COMBOUT, 0, -1) },
  { pnode(CMUXVG, 26, 39, CLKPIN, -1, 1), pnode(GPIO, 31, 39, COMBOUT, 0, -1) },
  { pnode(CMUXVR, 26, 39, CLKPIN, -1, 1), pnode(GPIO, 31, 39, COMBOUT, 0, -1) },
  { pnode(CMUXVG, 26, 39, CLKPIN, -1, 2), pnode(GPIO, 16, 39, COMBOUT, 0, -1) },
  { pnode(CMUXVR, 26, 39, CLKPIN, -1, 2), pnode(GPIO, 16, 39, COMBOUT, 0, -1) },
  { pnode(CMUXVG, 26, 39, CLKPIN, -1, 3), pnode(GPIO, 39, 39, COMBOUT, 0, -1) },
  { pnode(CMUXVR, 26, 39, CLKPIN, -1, 3), pnode(GPIO, 39, 39, COMBOUT, 0, -1) },
  { pnode(CMUXVG, 26, 39, NCLKPIN, -1, 0), pnode(GPIO, 8, 39, COMBOUT, 1, -1) },
  { pnode(CMUXVR, 26, 39, NCLKPIN, -1, 0), pnode(GPIO, 8, 39, COMBOUT, 1, -1) },
  { pnode(CMUXVG, 26, 39, NCLKPIN, -1, 1), pnode(GPIO, 31, 39, COMBOUT, 1, -1) },
  { pnode(CMUXVR, 26, 39, NCLKPIN, -1, 1), pnode(GPIO, 31, 39, COMBOUT, 1, -1) },
  { pnode(CMUXVG, 26, 39, NCLKPIN, -1, 2), pnode(GPIO, 16, 39, COMBOUT, 1, -1) },
  { pnode(CMUXVR, 26, 39, NCLKPIN, -1, 2), pnode(GPIO, 16, 39, COMBOUT, 1, -1) },
  { pnode(CMUXVG, 26, 39, NCLKPIN, -1, 3), pnode(GPIO, 39, 39, COMBOUT, 1, -1) },
  { pnode(CMUXVR, 26, 39, NCLKPIN, -1, 3), pnode(GPIO, 39, 39, COMBOUT, 1, -1) },
  { pnode(CMUXVG, 26, 39, PLLIN, -1, 0), pnode(FPLL, 0, 31, CLKOUT, -1, 5) },
  { pnode(CMUXVG, 26, 39, PLLIN, -1, 1), pnode(FPLL, 0, 31, CLKOUT, -1, 6) },
  { pnode(CMUXVG, 26, 39, PLLIN, -1, 2), pnode(FPLL, 0, 31, CLKOUT, -1, 7) },
  { pnode(CMUXVG, 26, 39, PLLIN, -1, 3), pnode(FPLL, 0, 31, CLKOUT, -1, 8) },
  { pnode(CMUXVG, 26, 39, PLLIN, -1, 4), pnode(FPLL, 48, 31, CLKOUT, -1, 8) },
  { pnode(CMUXVG, 26, 39, PLLIN, -1, 5), pnode(FPLL, 48, 31, CLKOUT, -1, 7) },
  { pnode(CMUXVG, 26, 39, PLLIN, -1, 6), pnode(FPLL, 48, 31, CLKOUT, -1, 6) },
  { pnode(CMUXVG, 26, 39, PLLIN, -1, 7), pnode(FPLL, 48, 31, CLKOUT, -1, 5) },
  { pnode(CMUXVR, 26, 39, PLLIN, -1, 0), pnode(FPLL, 48, 31, CLKOUT, -1, 8) },
  { pnode(CMUXVR, 26, 39, PLLIN, -1, 1), pnode(FPLL, 48, 31, CLKOUT, -1, 7) },
  { pnode(CMUXVR, 26, 39, PLLIN, -1, 2), pnode(FPLL, 48, 31, CLKOUT, -1, 6) },
  { pnode(CMUXVR, 26, 39, PLLIN, -1, 3), pnode(FPLL, 48, 31, CLKOUT, -1, 5) },
  { pnode(CMUXVR, 26, 39, PLLIN, -1, 4), pnode(FPLL, 48, 31, CLKOUT, -1, 4) },
  { pnode(CMUXVR, 26, 39, PLLIN, -1, 5), pnode(FPLL, 48, 31, CLKOUT, -1, 3) },
  { pnode(CMUXVR, 26, 39, PLLIN, -1, 6), pnode(FPLL, 48, 31, CLKOUT, -1, 2) },
  { pnode(CMUXVR, 26, 39, PLLIN, -1, 7), pnode(FPLL, 48, 31, CLKOUT, -1, 1) },
  { pnode(CMUXVR, 26, 39, PLLIN, -1, 8), pnode(FPLL, 48, 31, CLKOUT, -1, 0) },
  { pnode(CMUXCR, 48, 2, CLKPIN, -1, 0), pnode(GPIO, 32, 0, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 48, 2, CLKPIN, -1, 1), pnode(GPIO, 39, 0, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 48, 2, CLKPIN, -1, 2), pnode(GPIO, 48, 18, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 48, 2, NCLKPIN, -1, 0), pnode(GPIO, 32, 0, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 48, 2, NCLKPIN, -1, 1), pnode(GPIO, 39, 0, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 48, 2, NCLKPIN, -1, 2), pnode(GPIO, 48, 18, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 0), pnode(FPLL, 48, 0, CLKOUT, -1, 8) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 1), pnode(FPLL, 48, 0, CLKOUT, -1, 7) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 2), pnode(FPLL, 48, 0, CLKOUT, -1, 6) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 3), pnode(FPLL, 48, 0, CLKOUT, -1, 5) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 4), pnode(FPLL, 48, 0, CLKOUT, -1, 4) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 5), pnode(FPLL, 48, 0, CLKOUT, -1, 3) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 6), pnode(FPLL, 48, 0, CLKOUT, -1, 2) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 7), pnode(FPLL, 48, 0, CLKOUT, -1, 1) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 8), pnode(FPLL, 48, 0, CLKOUT, -1, 6) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 9), pnode(FPLL, 48, 0, CLKOUT, -1, 7) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 10), pnode(FPLL, 48, 0, CLKOUT, -1, 4) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 11), pnode(FPLL, 48, 0, CLKOUT, -1, 5) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 12), pnode(FPLL, 48, 0, CLKOUT, -1, 2) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 13), pnode(FPLL, 48, 0, CLKOUT, -1, 3) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 14), pnode(FPLL, 48, 0, CLKOUT, -1, 0) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 15), pnode(FPLL, 48, 0, CLKOUT, -1, 1) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 16), pnode(FPLL, 48, 0, CLKOUT, -1, 8) },
  { pnode(CMUXCR, 48, 2, PLLIN, -1, 17), pnode(FPLL, 48, 0, CLKOUT, -1, 0) },
  { pnode(CMUXHG, 48, 9, CLKPIN, -1, 2), pnode(GPIO, 48, 27, COMBOUT, 0, -1) },
  { pnode(CMUXHR, 48, 9, CLKPIN, -1, 2), pnode(GPIO, 48, 27, COMBOUT, 0, -1) },
  { pnode(CMUXHG, 48, 9, CLKPIN, -1, 5), pnode(GPIO, 48, 18, COMBOUT, 0, -1) },
  { pnode(CMUXHR, 48, 9, CLKPIN, -1, 5), pnode(GPIO, 48, 18, COMBOUT, 0, -1) },
  { pnode(CMUXHG, 48, 9, NCLKPIN, -1, 2), pnode(GPIO, 48, 27, COMBOUT, 1, -1) },
  { pnode(CMUXHR, 48, 9, NCLKPIN, -1, 2), pnode(GPIO, 48, 27, COMBOUT, 1, -1) },
  { pnode(CMUXHG, 48, 9, NCLKPIN, -1, 5), pnode(GPIO, 48, 18, COMBOUT, 1, -1) },
  { pnode(CMUXHR, 48, 9, NCLKPIN, -1, 5), pnode(GPIO, 48, 18, COMBOUT, 1, -1) },
  { pnode(CMUXHG, 48, 9, PLLIN, -1, 0), pnode(FPLL, 48, 31, CLKOUT, -1, 0) },
  { pnode(CMUXHG, 48, 9, PLLIN, -1, 1), pnode(FPLL, 48, 31, CLKOUT, -1, 1) },
  { pnode(CMUXHG, 48, 9, PLLIN, -1, 2), pnode(FPLL, 48, 31, CLKOUT, -1, 2) },
  { pnode(CMUXHG, 48, 9, PLLIN, -1, 3), pnode(FPLL, 48, 31, CLKOUT, -1, 3) },
  { pnode(CMUXHG, 48, 9, PLLIN, -1, 4), pnode(FPLL, 48, 0, CLKOUT, -1, 0) },
  { pnode(CMUXHG, 48, 9, PLLIN, -1, 5), pnode(FPLL, 48, 0, CLKOUT, -1, 1) },
  { pnode(CMUXHG, 48, 9, PLLIN, -1, 6), pnode(FPLL, 48, 0, CLKOUT, -1, 2) },
  { pnode(CMUXHG, 48, 9, PLLIN, -1, 7), pnode(FPLL, 48, 0, CLKOUT, -1, 3) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 0), pnode(FPLL, 48, 31, CLKOUT, -1, 0) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 1), pnode(FPLL, 48, 31, CLKOUT, -1, 1) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 2), pnode(FPLL, 48, 31, CLKOUT, -1, 2) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 3), pnode(FPLL, 48, 31, CLKOUT, -1, 3) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 4), pnode(FPLL, 48, 31, CLKOUT, -1, 4) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 5), pnode(FPLL, 48, 31, CLKOUT, -1, 5) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 6), pnode(FPLL, 48, 31, CLKOUT, -1, 6) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 7), pnode(FPLL, 48, 0, CLKOUT, -1, 0) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 8), pnode(FPLL, 48, 0, CLKOUT, -1, 1) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 9), pnode(FPLL, 48, 0, CLKOUT, -1, 2) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 10), pnode(FPLL, 48, 0, CLKOUT, -1, 3) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 11), pnode(FPLL, 48, 0, CLKOUT, -1, 4) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 12), pnode(FPLL, 48, 0, CLKOUT, -1, 5) },
  { pnode(CMUXHR, 48, 9, PLLIN, -1, 13), pnode(FPLL, 48, 0, CLKOUT, -1, 6) },
  { pnode(CMUXCR, 48, 37, CLKPIN, -1, 0), pnode(GPIO, 31, 39, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 48, 37, CLKPIN, -1, 1), pnode(GPIO, 39, 39, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 48, 37, CLKPIN, -1, 3), pnode(GPIO, 48, 27, COMBOUT, 0, -1) },
  { pnode(CMUXCR, 48, 37, NCLKPIN, -1, 0), pnode(GPIO, 31, 39, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 48, 37, NCLKPIN, -1, 1), pnode(GPIO, 39, 39, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 48, 37, NCLKPIN, -1, 3), pnode(GPIO, 48, 27, COMBOUT, 1, -1) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 0), pnode(FPLL, 48, 31, CLKOUT, -1, 8) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 1), pnode(FPLL, 48, 31, CLKOUT, -1, 7) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 2), pnode(FPLL, 48, 31, CLKOUT, -1, 6) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 3), pnode(FPLL, 48, 31, CLKOUT, -1, 5) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 4), pnode(FPLL, 48, 31, CLKOUT, -1, 4) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 5), pnode(FPLL, 48, 31, CLKOUT, -1, 3) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 6), pnode(FPLL, 48, 31, CLKOUT, -1, 2) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 7), pnode(FPLL, 48, 31, CLKOUT, -1, 1) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 8), pnode(FPLL, 48, 31, CLKOUT, -1, 6) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 9), pnode(FPLL, 48, 31, CLKOUT, -1, 7) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 10), pnode(FPLL, 48, 31, CLKOUT, -1, 4) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 11), pnode(FPLL, 48, 31, CLKOUT, -1, 5) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 12), pnode(FPLL, 48, 31, CLKOUT, -1, 2) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 13), pnode(FPLL, 48, 31, CLKOUT, -1, 3) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 14), pnode(FPLL, 48, 31, CLKOUT, -1, 0) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 15), pnode(FPLL, 48, 31, CLKOUT, -1, 1) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 16), pnode(FPLL, 48, 31, CLKOUT, -1, 8) },
  { pnode(CMUXCR, 48, 37, PLLIN, -1, 17), pnode(FPLL, 48, 31, CLKOUT, -1, 0) },
  ...
  { pnode(DLL, 0, 36, CLKIN, -1, -1), pnode(FPLL, 0, 31, CLKDOUT, -1, 0) },
  { pnode(DLL, 48, 3, CLKIN, -1, -1), pnode(FPLL, 48, 0, CLKDOUT, -1, 0) },
  { pnode(DLL, 48, 36, CLKIN, -1, -1), pnode(FPLL, 48, 31, CLKDOUT, -1, 0) },
  { }
};
