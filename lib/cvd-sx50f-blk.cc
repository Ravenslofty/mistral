...
const mistral::CycloneV::p2p_info mistral::CycloneV::sx50f_p2p_info[] = {
  ...
  { pnode(FPLL, 0, 53, CLKOUT, -1, 4), pnode(CMUXHR, 0, 8, PLLIN, -1, 0) },
  { pnode(FPLL, 0, 13, CLKOUT, -1, 7), pnode(CMUXHR, 0, 8, PLLIN, -1, 1) },
  { pnode(FPLL, 0, 53, CLKOUT, -1, 4), pnode(CMUXHR, 0, 8, PLLIN, -1, 2) },
  ...
  { pnode(FPLL, 0, 29, CLKOUT, -1, 8), pnode(CMUXHR, 0, 8, PLLIN, -1, 8) },
  { pnode(FPLL, 0, 29, CLKOUT, -1, 7), pnode(CMUXHR, 0, 8, PLLIN, -1, 9) },
  { pnode(FPLL, 0, 29, CLKOUT, -1, 6), pnode(CMUXHR, 0, 8, PLLIN, -1, 10) },
  { pnode(FPLL, 0, 29, CLKOUT, -1, 5), pnode(CMUXHR, 0, 8, PLLIN, -1, 11) },
  ...
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 8), pnode(CMUXVG, 28, 61, PLLIN, -1, 4) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 7), pnode(CMUXVG, 28, 61, PLLIN, -1, 5) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 6), pnode(CMUXVG, 28, 61, PLLIN, -1, 6) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 5), pnode(CMUXVG, 28, 61, PLLIN, -1, 7) },
  ...
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 8), pnode(CMUXVR, 28, 61, PLLIN, -1, 0) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 7), pnode(CMUXVR, 28, 61, PLLIN, -1, 1) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 6), pnode(CMUXVR, 28, 61, PLLIN, -1, 2) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 5), pnode(CMUXVR, 28, 61, PLLIN, -1, 3) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 4), pnode(CMUXVR, 28, 61, PLLIN, -1, 4) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 3), pnode(CMUXVR, 28, 61, PLLIN, -1, 5) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 2), pnode(CMUXVR, 28, 61, PLLIN, -1, 6) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 1), pnode(CMUXVR, 28, 61, PLLIN, -1, 7) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 1, 0), pnode(CMUXVR, 28, 61, PLLIN, -1, 8) },
  ...
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 0), pnode(CMUXHG, 68, 8, PLLIN, -1, 0) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 1), pnode(CMUXHG, 68, 8, PLLIN, -1, 1) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 2), pnode(CMUXHG, 68, 8, PLLIN, -1, 2) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 3), pnode(CMUXHG, 68, 8, PLLIN, -1, 3) },
  ...
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 0), pnode(CMUXHR, 68, 8, PLLIN, -1, 0) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 1), pnode(CMUXHR, 68, 8, PLLIN, -1, 1) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 2), pnode(CMUXHR, 68, 8, PLLIN, -1, 2) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 3), pnode(CMUXHR, 68, 8, PLLIN, -1, 3) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 4), pnode(CMUXHR, 68, 8, PLLIN, -1, 4) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 5), pnode(CMUXHR, 68, 8, PLLIN, -1, 5) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 6), pnode(CMUXHR, 68, 8, PLLIN, -1, 6) },
  ...
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 8), pnode(CMUXHR, 68, 8, PLLIN, -1, 20) },
  { pnode(HPS_CMUX, 68, 61, CLKOUT, 0, 7), pnode(CMUXHR, 68, 8, PLLIN, -1, 21) },
